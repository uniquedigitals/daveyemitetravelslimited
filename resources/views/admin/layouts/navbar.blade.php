            ...
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="dropdown d-none d-sm-inline-block">
                    <button
                        ...
                        <img src="{{ asset('admins/images/lang-flag.png') }}" alt="image"
                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-8">
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        ...
                                        <img src="admins/images/flags/flag1.png" alt=""
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag2.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag3.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag4.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag5.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag6.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag7.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                            ...
                            <div
                                ...
                                <label class="form-check-label line-height-1 fw-medium text-secondary-light"
                                    ...
                                    <span
                                        class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                        <img src="admins/images/flags/flag8.png" alt=""
                                            class="w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0">
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle"
                        type="button" data-bs-toggle="dropdown">
                        <img src="admins/images/user.png" alt="image"
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div
                            class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2">{{ $home->site_name }}
                                </h6>
