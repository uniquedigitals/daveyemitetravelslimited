...
<head>
  ...
  <title>Login -{{ $home->site_name . ' - '. $home->site_description  }}</title>
            ...
            <form method="post" action="{{ route('login') }}">
                ...
                <div class="position-relative mb-20">
                    <div class="icon-field">
                        ...
                        <input name="password" type="password"  class="form-control h-56-px bg-neutral-50 radius-12" id="your-password" placeholder="Password">
                    </div>
                ...
                <div class="">
                    <div class="d-flex justify-content-between gap-2">
                        <div class="form-check style-check d-flex align-items-center">
                            <input class="form-check-input border border-neutral-300" type="checkbox" name="remember" value="1" id="remeber">
